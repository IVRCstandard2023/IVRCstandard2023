...
void setup() {
    ...
    uduino.addCommand("rd", ReadDigitalPin);  // digital read のコマンド
    uduino.addCommand("r", ReadAnalogPin);    // 追加: analog read のコマンド
}
...
void ReadAnalogPin() {
    ...
    {
        pinToRead = atoi(arg);
        int readValue = analogRead(pinToRead);
        uduino.println(readValue);
    }
}
